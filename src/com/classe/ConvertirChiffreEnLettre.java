 ...
 * @author GERALD
 */
public class ConvertirChiffreEnLettre {
    ...
    public ConvertirChiffreEnLettre(){}
    ...
    public static void main(String[] args) {
        ...
        String lettre = (decimal > 0) ? c.convert(entier) + " virgule " + c.convert(decimal) : c.convert(entier);
